...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        func createTabBar() -> UITabBarController {
            ...
            tabBarController.viewControllers = [flagsNavController(), favoritesController()]
        ...
        func flagsNavController() -> UINavigationController {
            let countryListViewController = CountryListViewController()
            countryListViewController.title = "World Countries"
            countryListViewController.reloadInputViews()
        ...
        func favoritesController() -> UINavigationController {
            ...
            favoriteListViewController.title = "Favorite Countries"
            let navController = UINavigationController(rootViewController: favoriteListViewController)
            return navController
        }
    }
